...
public class PBulletManager : MonoBehaviour
{
	...
	[SerializeField] private float _bulletMagazineCount = 140f;
	...
	public void SetMagazineCount(float newBulletMagCount)
	{
		this._bulletMagazineCount = newBulletMagCount;
	}

	public float DecrementMagazineCount()
	{
		return --this._bulletMagazineCount;
	}

	public float GetCurrentMagazineCount()
	{
		return this._bulletMagazineCount;
	}
